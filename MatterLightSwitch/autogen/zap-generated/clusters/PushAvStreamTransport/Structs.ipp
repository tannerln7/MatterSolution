...
if (__context_tag == to_underlying(Fields::kAugmentationDuration))
        {
...
if (__context_tag == to_underlying(Fields::kBlindDuration))
        {
...
if (__context_tag == to_underlying(Fields::kSensitivity))
        {
...
if (__context_tag == to_underlying(Fields::kMotionZones))
        {
          err = DataModel::Decode(reader, motionZones);
        }
        else
if (__context_tag == to_underlying(Fields::kMotionSensitivity))
        {
          err = DataModel::Decode(reader, motionSensitivity);
        }
        else
if (__context_tag == to_underlying(Fields::kMotionTimeControl))
        {
          err = DataModel::Decode(reader, motionTimeControl);
        }
        else
if (__context_tag == to_underlying(Fields::kMaxPreRollLen))
        {
...
if (__context_tag == to_underlying(Fields::kCENCKey))
        {
...
if (__context_tag == to_underlying(Fields::kCENCKeyID))
        {
...
if (__context_tag == to_underlying(Fields::kCMAFContainerOptions))
        {
...
if (__context_tag == to_underlying(Fields::kTriggerOptions))
        {
          err = DataModel::Decode(reader, triggerOptions);
        }
        else
if (__context_tag == to_underlying(Fields::kIngestMethod))
        {
          err = DataModel::Decode(reader, ingestMethod);
        }
        else
if (__context_tag == to_underlying(Fields::kContainerOptions))
        {
          err = DataModel::Decode(reader, containerOptions);
        }
        else
if (__context_tag == to_underlying(Fields::kExpiryTime))
        {
...
if (__context_tag == to_underlying(Fields::kTransportStatus))
        {
