...
CHIP_ERROR Type::Encode(DataModel::FabricAwareTLVWriter & aWriter, TLV::Tag aTag) const {
    DataModel::WrappedStructEncoder encoder{aWriter, aTag};
    encoder.EncodeResponseCommandFabricScopedStructField(to_underlying(Fields::kCertificateDetails), aWriter.mAccessingFabricIndex, certificateDetails);
    return encoder.Finalize();
}
...
if (__context_tag == to_underlying(Fields::kCsr))
        {
...
if (__context_tag == to_underlying(Fields::kClientCertificateDetails))
        {
            err = DataModel::Decode(reader, clientCertificateDetails);            if (err == CHIP_NO_ERROR)
            {
