...
inline constexpr DataModel::AttributeEntry kMetadataEntry(
    CurrentPositionLiftPercentage::Id,
    BitFlags<DataModel::AttributeQualityFlags>(),
    Access::Privilege::kView,
    std::nullopt
);
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(
    CurrentPositionTiltPercentage::Id,
    BitFlags<DataModel::AttributeQualityFlags>(),
    Access::Privilege::kView,
    std::nullopt
);
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(
    TargetPositionTiltPercent100ths::Id,
    BitFlags<DataModel::AttributeQualityFlags>(),
    Access::Privilege::kView,
    std::nullopt
);
...
inline constexpr DataModel::AttributeEntry kMetadataEntry(
    CurrentPositionTiltPercent100ths::Id,
    BitFlags<DataModel::AttributeQualityFlags>(),
    Access::Privilege::kView,
    std::nullopt
);
