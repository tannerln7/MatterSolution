...
if (__context_tag == to_underlying(Fields::kSDPMid))
        {
          err = DataModel::Decode(reader, SDPMid);
        }
        else
if (__context_tag == to_underlying(Fields::kSDPMLineIndex))
        {
...
if (__context_tag == to_underlying(Fields::kApparentPowerThreshold))
        {
          err = DataModel::Decode(reader, apparentPowerThreshold);
        }
        else
if (__context_tag == to_underlying(Fields::kPowerThresholdSource))
        {
...
if (__context_tag == to_underlying(Fields::kY1))
        {
          err = DataModel::Decode(reader, y1);
        }
        else
if (__context_tag == to_underlying(Fields::kX2))
        {
          err = DataModel::Decode(reader, x2);
        }
        else
if (__context_tag == to_underlying(Fields::kY2))
        {
...
if (__context_tag == to_underlying(Fields::kPeerEndpointID))
        {
