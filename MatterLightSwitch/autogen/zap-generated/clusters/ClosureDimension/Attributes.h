...
namespace CurrentState {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::Nullable<chip::app::Clusters::ClosureDimension::Structs::CurrentStateStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::ClosureDimension::Structs::CurrentStateStruct::DecodableType> &;
...
namespace Target {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::Nullable<chip::app::Clusters::ClosureDimension::Structs::TargetStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::ClosureDimension::Structs::TargetStruct::DecodableType> &;
...
namespace UnitRange {
      struct TypeInfo {
          ...
          using DecodableType = chip::app::DataModel::Nullable<chip::app::Clusters::ClosureDimension::Structs::UnitRangeStruct::DecodableType>;
          using DecodableArgType = const chip::app::DataModel::Nullable<chip::app::Clusters::ClosureDimension::Structs::UnitRangeStruct::DecodableType> &;
...
struct TypeInfo
{
    struct DecodableType {
        ...
        Attributes::TranslationDirection::TypeInfo::DecodableType translationDirection     = static_cast<chip::app::Clusters::ClosureDimension::TranslationDirectionEnum>(0);
        Attributes::RotationAxis::TypeInfo::DecodableType rotationAxis     = static_cast<chip::app::Clusters::ClosureDimension::RotationAxisEnum>(0);
        Attributes::Overflow::TypeInfo::DecodableType overflow     = static_cast<chip::app::Clusters::ClosureDimension::OverflowEnum>(0);
        Attributes::ModulationType::TypeInfo::DecodableType modulationType     = static_cast<chip::app::Clusters::ClosureDimension::ModulationTypeEnum>(0);
